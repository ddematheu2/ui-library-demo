    ...
    <FluentThemeProvider>
        <div>
          ...
          <ControlBar layout={'dockedBottom'}>
            ...
            <MicrophoneButton {...micButtonProps}/>
            <ScreenShareButton {...screenButtonProps}/>
            <EndCallButton {...endButtonProps}/>
          </ControlBar>
        </div>
    </FluentThemeProvider>
  );
